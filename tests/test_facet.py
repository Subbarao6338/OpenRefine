...
class EngineTest(unittest.TestCase):
    ...
    def test_serialize(self):
        ...
        self.assertEqual(facet.as_dict(), {'selectError': False,
                                           'name': 'column',
                                           'selection': [],
                                           'expression': 'value',
                                           'invert': False,
        ...
        self.assertEqual(facet.as_dict(), {'from': 1, 'to': 5,
                                           'selectBlank': True,
                                           'name': 'column',
                                           'selectError': True,
                                           'expression': 'value',
...
class FacetsResponseTest(unittest.TestCase):
    response = """{"facets":[{"name":"Party Code","expression":"value","columnName":"Party Code","invert":false,
    "choices":[{"v":{"v":"D","l":"D"},"c":3700,"s":false},{"v":{"v":"R","l":"R"},"c":1613,"s":false},{"v":{"v":"N",
    "l":"N"},"c":15,"s":false},{"v":{"v":"O","l":"O"},"c":184,"s":false}],"blankChoice":{"s":false,"c":1446}}],
    "mode":"row-based"} """
