...
class RefineProjectTest(unittest.TestCase):
    ...
    def test_server_init(self):
        ...
        p = RP('http://127.0.0.1:3333/project?project=1714438453443')
        self.assertEqual(p.server.server, 'http://127.0.0.1:3333')
        self.assertEqual(p.project_id, '1714438453443')
        p = RP('http://127.0.0.1:3333', '1714438453443')
        self.assertEqual(p.server.server, 'http://127.0.0.1:3333')
        self.assertEqual(p.project_id, '1714438453443')
        p = RP('http://127.0.0.1:3333/command/core/get-history?project=1714438453443')
        self.assertEqual(p.server.server, 'http://127.0.0.1:3333')
        self.assertEqual(p.project_id, '1714438453443')
        p = RP('1714438453443')
        self.assertEqual(p.server.server, 'http://127.0.0.1')
        self.assertEqual(p.project_id, '1714438453443')
